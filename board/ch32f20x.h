...
#define  FLASH_STATR_WR_BSY                    ((uint8_t)0x02)               /* Write Read Busy */
...
/*******************  Bit definition for GPIO_CFG MASK register  *******************/
#define  GPIO_CFG_MASK_PIN_0                   ((uint32_t)0xFFFFFFF0)        /* MODE0[1:0] CNF0[1:0] bits mask (Port x mode bits, pin 0) */
#define  GPIO_CFG_MASK_PIN_1                   ((uint32_t)0xFFFFFF0F)        /* MODE1[1:0] CNF1[1:0] bits mask (Port x mode bits, pin 1) */
#define  GPIO_CFG_MASK_PIN_2                   ((uint32_t)0xFFFFF0FF)        /* MODE2[1:0] CNF2[1:0] bits mask (Port x mode bits, pin 2) */
#define  GPIO_CFG_MASK_PIN_3                   ((uint32_t)0xFFFF0FFF)        /* MODE3[1:0] CNF3[1:0] bits mask (Port x mode bits, pin 3) */
#define  GPIO_CFG_MASK_PIN_4                   ((uint32_t)0xFFF0FFFF)        /* MODE4[1:0] CNF4[1:0] bits mask (Port x mode bits, pin 4) */
#define  GPIO_CFG_MASK_PIN_5                   ((uint32_t)0xFF0FFFFF)        /* MODE5[1:0] CNF5[1:0] bits mask (Port x mode bits, pin 5) */
#define  GPIO_CFG_MASK_PIN_6                   ((uint32_t)0xF0FFFFFF)        /* MODE6[1:0] CNF6[1:0] bits mask (Port x mode bits, pin 6) */
#define  GPIO_CFG_MASK_PIN_7                   ((uint32_t)0x0FFFFFFF)        /* MODE7[1:0] CNF7[1:0] bits mask (Port x mode bits, pin 7) */
#define  GPIO_CFG_MASK_PIN_8                   ((uint32_t)0xFFFFFFF0)        /* MODE8[1:0] CNF8[1:0] bits mask (Port x mode bits, pin 8) */
#define  GPIO_CFG_MASK_PIN_9                   ((uint32_t)0xFFFFFF0F)        /* MODE9[1:0] CNF9[1:0] bits mask (Port x mode bits, pin 9) */
#define  GPIO_CFG_MASK_PIN_10                  ((uint32_t)0xFFFFF0FF)        /* MODE10[1:0] CNF10[1:0] bits mask (Port x mode bits, pin 10) */
#define  GPIO_CFG_MASK_PIN_11                  ((uint32_t)0xFFFF0FFF)        /* MODE11[1:0] CNF11[1:0] bits mask (Port x mode bits, pin 11) */
#define  GPIO_CFG_MASK_PIN_12                  ((uint32_t)0xFFF0FFFF)        /* MODE12[1:0] CNF12[1:0] bits mask (Port x mode bits, pin 12) */
#define  GPIO_CFG_MASK_PIN_13                  ((uint32_t)0xFF0FFFFF)        /* MODE13[1:0] CNF13[1:0] bits mask (Port x mode bits, pin 13) */
#define  GPIO_CFG_MASK_PIN_14                  ((uint32_t)0xF0FFFFFF)        /* MODE14[1:0] CNF14[1:0] bits mask (Port x mode bits, pin 14) */
#define  GPIO_CFG_MASK_PIN_15                  ((uint32_t)0x0FFFFFFF)        /* MODE15[1:0] CNF15[1:0] bits mask (Port x mode bits, pin 15) */

/*******************  Bit definition for GPIO_CFG analog input register  *******************/
#define  GPIO_CFG_AIN_PIN_0                    ((uint32_t)0x00000000)        /* MODE0[1:0] = 00 CNF0[1:0] = 00 analog input (Port x mode bits, pin 0) */
#define  GPIO_CFG_AIN_PIN_1                    ((uint32_t)0x00000000)        /* MODE1[1:0] = 00 CNF1[1:0] = 00 analog input (Port x mode bits, pin 1) */
#define  GPIO_CFG_AIN_PIN_2                    ((uint32_t)0x00000000)        /* MODE2[1:0] = 00 CNF2[1:0] = 00 analog input (Port x mode bits, pin 2) */
#define  GPIO_CFG_AIN_PIN_3                    ((uint32_t)0x00000000)        /* MODE3[1:0] = 00 CNF3[1:0] = 00 analog input (Port x mode bits, pin 3) */
#define  GPIO_CFG_AIN_PIN_4                    ((uint32_t)0x00000000)        /* MODE4[1:0] = 00 CNF4[1:0] = 00 analog input (Port x mode bits, pin 4) */
#define  GPIO_CFG_AIN_PIN_5                    ((uint32_t)0x00000000)        /* MODE5[1:0] = 00 CNF5[1:0] = 00 analog input (Port x mode bits, pin 5) */
#define  GPIO_CFG_AIN_PIN_6                    ((uint32_t)0x00000000)        /* MODE6[1:0] = 00 CNF6[1:0] = 00 analog input (Port x mode bits, pin 6) */
#define  GPIO_CFG_AIN_PIN_7                    ((uint32_t)0x00000000)        /* MODE7[1:0] = 00 CNF7[1:0] = 00 analog input (Port x mode bits, pin 7) */
#define  GPIO_CFG_AIN_PIN_8                    ((uint32_t)0x00000000)        /* MODE8[1:0] = 00 CNF8[1:0] = 00 analog input (Port x mode bits, pin 8) */
#define  GPIO_CFG_AIN_PIN_9                    ((uint32_t)0x00000000)        /* MODE9[1:0] = 00 CNF9[1:0] = 00 analog input (Port x mode bits, pin 9) */
#define  GPIO_CFG_AIN_PIN_10                   ((uint32_t)0x00000000)        /* MODE10[1:0] = 00 CNF10[1:0] = 00 analog input (Port x mode bits, pin 10) */
#define  GPIO_CFG_AIN_PIN_11                   ((uint32_t)0x00000000)        /* MODE11[1:0] = 00 CNF11[1:0] = 00 analog input (Port x mode bits, pin 11) */
#define  GPIO_CFG_AIN_PIN_12                   ((uint32_t)0x00000000)        /* MODE12[1:0] = 00 CNF12[1:0] = 00 analog input (Port x mode bits, pin 12) */
#define  GPIO_CFG_AIN_PIN_13                   ((uint32_t)0x00000000)        /* MODE13[1:0] = 00 CNF13[1:0] = 00 analog input (Port x mode bits, pin 13) */
#define  GPIO_CFG_AIN_PIN_14                   ((uint32_t)0x00000000)        /* MODE14[1:0] = 00 CNF14[1:0] = 00 analog input (Port x mode bits, pin 14) */
#define  GPIO_CFG_AIN_PIN_15                   ((uint32_t)0x00000000)        /* MODE15[1:0] = 00 CNF15[1:0] = 00 analog input (Port x mode bits, pin 15) */

/*******************  Bit definition for GPIO_CFG floating input register  *******************/
#define  GPIO_CFG_FIN_PIN_0                    ((uint32_t)0x00000004)        /* MODE0[1:0] = 00 CNF0[1:0] = 01 floating input (Port x mode bits, pin 0) */
#define  GPIO_CFG_FIN_PIN_1                    ((uint32_t)0x00000040)        /* MODE1[1:0] = 00 CNF1[1:0] = 01 floating input (Port x mode bits, pin 1) */
#define  GPIO_CFG_FIN_PIN_2                    ((uint32_t)0x00000400)        /* MODE2[1:0] = 00 CNF2[1:0] = 01 floating input (Port x mode bits, pin 2) */
#define  GPIO_CFG_FIN_PIN_3                    ((uint32_t)0x00004000)        /* MODE3[1:0] = 00 CNF3[1:0] = 01 floating input (Port x mode bits, pin 3) */
#define  GPIO_CFG_FIN_PIN_4                    ((uint32_t)0x00040000)        /* MODE4[1:0] = 00 CNF4[1:0] = 01 floating input (Port x mode bits, pin 4) */
#define  GPIO_CFG_FIN_PIN_5                    ((uint32_t)0x00400000)        /* MODE5[1:0] = 00 CNF5[1:0] = 01 floating input (Port x mode bits, pin 5) */
#define  GPIO_CFG_FIN_PIN_6                    ((uint32_t)0x04000000)        /* MODE6[1:0] = 00 CNF6[1:0] = 01 floating input (Port x mode bits, pin 6) */
#define  GPIO_CFG_FIN_PIN_7                    ((uint32_t)0x40000000)        /* MODE7[1:0] = 00 CNF7[1:0] = 01 floating input (Port x mode bits, pin 7) */
#define  GPIO_CFG_FIN_PIN_8                    ((uint32_t)0x00000004)        /* MODE8[1:0] = 00 CNF8[1:0] = 01 floating input (Port x mode bits, pin 8) */
#define  GPIO_CFG_FIN_PIN_9                    ((uint32_t)0x00000040)        /* MODE9[1:0] = 00 CNF9[1:0] = 01 floating input (Port x mode bits, pin 9) */
#define  GPIO_CFG_FIN_PIN_10                   ((uint32_t)0x00000400)        /* MODE10[1:0] = 00 CNF10[1:0] = 01 floating input (Port x mode bits, pin 10) */
#define  GPIO_CFG_FIN_PIN_11                   ((uint32_t)0x00004000)        /* MODE11[1:0] = 00 CNF11[1:0] = 01 floating input (Port x mode bits, pin 11) */
#define  GPIO_CFG_FIN_PIN_12                   ((uint32_t)0x00040000)        /* MODE12[1:0] = 00 CNF12[1:0] = 01 floating input (Port x mode bits, pin 12) */
#define  GPIO_CFG_FIN_PIN_13                   ((uint32_t)0x00400000)        /* MODE13[1:0] = 00 CNF13[1:0] = 01 floating input (Port x mode bits, pin 13) */
#define  GPIO_CFG_FIN_PIN_14                   ((uint32_t)0x04000000)        /* MODE14[1:0] = 00 CNF14[1:0] = 01 floating input (Port x mode bits, pin 14) */
#define  GPIO_CFG_FIN_PIN_15                   ((uint32_t)0x40000000)        /* MODE15[1:0] = 00 CNF15[1:0] = 01 floating input (Port x mode bits, pin 15) */

/*******************  Bit definition for GPIO_CFG push-pull output register  *******************/
#define  GPIO_CFG_OPP_PIN_0                    ((uint32_t)0x00000003)        /* MODE0[1:0] = 11 CNF0[1:0] = 00 push-pull output (Port x mode bits, pin 0) */
#define  GPIO_CFG_OPP_PIN_1                    ((uint32_t)0x00000030)        /* MODE1[1:0] = 11 CNF1[1:0] = 00 push-pull output (Port x mode bits, pin 1) */
#define  GPIO_CFG_OPP_PIN_2                    ((uint32_t)0x00000300)        /* MODE2[1:0] = 11 CNF2[1:0] = 00 push-pull output (Port x mode bits, pin 2) */
#define  GPIO_CFG_OPP_PIN_3                    ((uint32_t)0x00003000)        /* MODE3[1:0] = 11 CNF3[1:0] = 00 push-pull output (Port x mode bits, pin 3) */
#define  GPIO_CFG_OPP_PIN_4                    ((uint32_t)0x00030000)        /* MODE4[1:0] = 11 CNF4[1:0] = 00 push-pull output (Port x mode bits, pin 4) */
#define  GPIO_CFG_OPP_PIN_5                    ((uint32_t)0x00300000)        /* MODE5[1:0] = 11 CNF5[1:0] = 00 push-pull output (Port x mode bits, pin 5) */
#define  GPIO_CFG_OPP_PIN_6                    ((uint32_t)0x03000000)        /* MODE6[1:0] = 11 CNF6[1:0] = 00 push-pull output (Port x mode bits, pin 6) */
#define  GPIO_CFG_OPP_PIN_7                    ((uint32_t)0x30000000)        /* MODE7[1:0] = 11 CNF7[1:0] = 00 push-pull output (Port x mode bits, pin 7) */
#define  GPIO_CFG_OPP_PIN_8                    ((uint32_t)0x00000003)        /* MODE8[1:0] = 11 CNF8[1:0] = 00 push-pull output (Port x mode bits, pin 8) */
#define  GPIO_CFG_OPP_PIN_9                    ((uint32_t)0x00000030)        /* MODE9[1:0] = 11 CNF9[1:0] = 00 push-pull output (Port x mode bits, pin 9) */
#define  GPIO_CFG_OPP_PIN_10                   ((uint32_t)0x00000300)        /* MODE10[1:0] = 11 CNF10[1:0] = 00 push-pull output (Port x mode bits, pin 10) */
#define  GPIO_CFG_OPP_PIN_11                   ((uint32_t)0x00003000)        /* MODE11[1:0] = 11 CNF11[1:0] = 00 push-pull output (Port x mode bits, pin 11) */
#define  GPIO_CFG_OPP_PIN_12                   ((uint32_t)0x00030000)        /* MODE12[1:0] = 11 CNF12[1:0] = 00 push-pull output (Port x mode bits, pin 12) */
#define  GPIO_CFG_OPP_PIN_13                   ((uint32_t)0x00300000)        /* MODE13[1:0] = 11 CNF13[1:0] = 00 push-pull output (Port x mode bits, pin 13) */
#define  GPIO_CFG_OPP_PIN_14                   ((uint32_t)0x03000000)        /* MODE14[1:0] = 11 CNF14[1:0] = 00 push-pull output (Port x mode bits, pin 14) */
#define  GPIO_CFG_OPP_PIN_15                   ((uint32_t)0x30000000)        /* MODE15[1:0] = 11 CNF15[1:0] = 00 push-pull output (Port x mode bits, pin 15) */

/*******************  Bit definition for GPIO_CFG multiplexed push-pull output register  *******************/
#define  GPIO_CFG_APP_PIN_0                    ((uint32_t)0x0000000B)        /* MODE0[1:0] = 11 CNF0[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 0) */
#define  GPIO_CFG_APP_PIN_1                    ((uint32_t)0x000000B0)        /* MODE1[1:0] = 11 CNF1[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 1) */
#define  GPIO_CFG_APP_PIN_2                    ((uint32_t)0x00000B00)        /* MODE2[1:0] = 11 CNF2[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 2) */
#define  GPIO_CFG_APP_PIN_3                    ((uint32_t)0x0000B000)        /* MODE3[1:0] = 11 CNF3[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 3) */
#define  GPIO_CFG_APP_PIN_4                    ((uint32_t)0x000B0000)        /* MODE4[1:0] = 11 CNF4[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 4) */
#define  GPIO_CFG_APP_PIN_5                    ((uint32_t)0x00B00000)        /* MODE5[1:0] = 11 CNF5[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 5) */
#define  GPIO_CFG_APP_PIN_6                    ((uint32_t)0x0B000000)        /* MODE6[1:0] = 11 CNF6[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 6) */
#define  GPIO_CFG_APP_PIN_7                    ((uint32_t)0xB0000000)        /* MODE7[1:0] = 11 CNF7[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 7) */
#define  GPIO_CFG_APP_PIN_8                    ((uint32_t)0x0000000B)        /* MODE8[1:0] = 11 CNF8[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 8) */
#define  GPIO_CFG_APP_PIN_9                    ((uint32_t)0x000000B0)        /* MODE9[1:0] = 11 CNF9[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 9) */
#define  GPIO_CFG_APP_PIN_10                   ((uint32_t)0x00000B00)        /* MODE10[1:0] = 11 CNF10[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 10) */
#define  GPIO_CFG_APP_PIN_11                   ((uint32_t)0x0000B000)        /* MODE11[1:0] = 11 CNF11[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 11) */
#define  GPIO_CFG_APP_PIN_12                   ((uint32_t)0x000B0000)        /* MODE12[1:0] = 11 CNF12[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 12) */
#define  GPIO_CFG_APP_PIN_13                   ((uint32_t)0x00B00000)        /* MODE13[1:0] = 11 CNF13[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 13) */
#define  GPIO_CFG_APP_PIN_14                   ((uint32_t)0x0B000000)        /* MODE14[1:0] = 11 CNF14[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 14) */
#define  GPIO_CFG_APP_PIN_15                   ((uint32_t)0xB0000000)        /* MODE15[1:0] = 11 CNF15[1:0] = 10 multiplexed push-pull output (Port x mode bits, pin 15) */
...
#ifdef CH32F20x_D8C
#define  RCC_USBHS_SRC_PLL_CLK           ((uint32_t)0x00000000)        /* USBHS 48M CLK SRC PLL */
#define  RCC_USBHS_SRC_USB_PHY           ((uint32_t)0x80000000)        /* USBHS 48M CLK SRC PHY */
#define  RCC_USBHS_SRC_MASK              ((uint32_t)0x7FFFFFFF)        /* USBHS 48M CLK SRC MASK */

#define  RCC_USBHS_PLL_SRC_HSE           ((uint32_t)0x00000000)        /* USBHS PLL SRC HSE */
#define  RCC_USBHS_PLL_SRC_HSI           ((uint32_t)0x08000000)        /* USBHS PLL SRC HSI */
#define  RCC_USBHS_PLL_SRC_MSAK          ((uint32_t)0xF7FFFFFF)        /* USBHS PLL SRC MASK */

#define  RCC_USBHS_DIV1                  ((uint32_t)0x00000000)        /* USBHS PLL DIV 1 */
#define  RCC_USBHS_DIV2                  ((uint32_t)0x01000000)        /* USBHS PLL DIV 2 */
#define  RCC_USBHS_DIV3                  ((uint32_t)0x02000000)        /* USBHS PLL DIV 3 */
#define  RCC_USBHS_DIV4                  ((uint32_t)0x03000000)        /* USBHS PLL DIV 4 */
#define  RCC_USBHS_DIV5                  ((uint32_t)0x04000000)        /* USBHS PLL DIV 5 */
#define  RCC_USBHS_DIV6                  ((uint32_t)0x05000000)        /* USBHS PLL DIV 6 */
#define  RCC_USBHS_DIV7                  ((uint32_t)0x06000000)        /* USBHS PLL DIV 7 */
#define  RCC_USBHS_DIV8                  ((uint32_t)0x07000000)        /* USBHS PLL DIV 8 */
#define  RCC_USBHS_DIV_MASK              ((uint32_t)0xF8FFFFFF)        /* USBHS PLL DIV MASK */

#define  RCC_USBHS_CLK_3M                ((uint32_t)0x00000000)        /* USBHS PLL CLOCK 3M */
#define  RCC_USBHS_CLK_4M                ((uint32_t)0x10000000)        /* USBHS PLL CLOCK 4M */
#define  RCC_USBHS_CLK_8M                ((uint32_t)0x20000000)        /* USBHS PLL CLOCK 8M */
#define  RCC_USBHS_CLK_5M                ((uint32_t)0x30000000)        /* USBHS PLL CLOCK 5M */
#define  RCC_USBHS_CLK_MASK              ((uint32_t)0xCFFFFFFF)        /* USBHS PLL CLOCK MASK */

#define  RCC_USBHS_PLL_ENABLE            ((uint32_t)0x40000000)        /* USBHS PLL CLOCK ENABLE */
#endif
...
#ifdef CH32F20x_D8C
#define  RCC_USBHS                       ((uint16_t)0x0800)
#endif
...
#define  RCC_SPI2EN                      ((uint32_t)0x00004000)        /* SPI 2 clock enable */
...
#define  SPI_CTLR1_BR_PRE2                   ((uint16_t)0x0000)            /* BR[2:0] = 0 div = 2 */
#define  SPI_CTLR1_BR_PRE4                   ((uint16_t)0x0008)            /* BR[2:0] = 1 div = 4 */
#define  SPI_CTLR1_BR_PRE8                   ((uint16_t)0x0010)            /* BR[2:0] = 2 div = 8 */
#define  SPI_CTLR1_BR_PRE16                  ((uint16_t)0x0018)            /* BR[2:0] = 3 div = 16 */
#define  SPI_CTLR1_BR_PRE32                  ((uint16_t)0x0020)            /* BR[2:0] = 4 div = 32 */
#define  SPI_CTLR1_BR_PRE64                  ((uint16_t)0x0028)            /* BR[2:0] = 5 div = 64 */
#define  SPI_CTLR1_BR_PRE128                 ((uint16_t)0x0030)            /* BR[2:0] = 6 div = 128 */
#define  SPI_CTLR1_BR_PRE256                 ((uint16_t)0x0038)            /* BR[2:0] = 7 div = 256 */
