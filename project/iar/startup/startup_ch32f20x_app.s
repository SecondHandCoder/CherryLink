...
* Version            : V1.0.0
* Date               : 2023/11/18
* Description        : CH32F20x vector table for IAR toolchain.
*******************************************************************************/
...
OTG_FS_IRQHandler
        ...
        PUBWEAK USBHSWakeup_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
USBHSWakeup_IRQHandler
        B USBHSWakeup_IRQHandler
...
UART8_IRQHandler
        ...
        PUBWEAK TIM9_BRK_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
TIM9_BRK_IRQHandler
        B TIM9_BRK_IRQHandler

        PUBWEAK TIM9_UP_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
TIM9_UP_IRQHandler
        B TIM9_UP_IRQHandler

        PUBWEAK TIM9_TRG_COM_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
TIM9_TRG_COM_IRQHandler
        B TIM9_TRG_COM_IRQHandler

        PUBWEAK TIM9_CC_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
TIM9_CC_IRQHandler
        B TIM9_CC_IRQHandler

        PUBWEAK TIM10_BRK_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
TIM10_BRK_IRQHandler
        B TIM10_BRK_IRQHandler

        PUBWEAK TIM10_UP_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
TIM10_UP_IRQHandler
        B TIM10_UP_IRQHandler

        PUBWEAK TIM10_TRG_COM_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
TIM10_TRG_COM_IRQHandler
        B TIM10_TRG_COM_IRQHandler

        PUBWEAK TIM10_CC_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
TIM10_CC_IRQHandler
        B TIM10_CC_IRQHandler
...
DMA2_Channel8_IRQHandler
        ...
        PUBWEAK DMA2_Channel9_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
DMA2_Channel9_IRQHandler
        B DMA2_Channel9_IRQHandler

        PUBWEAK DMA2_Channel10_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
DMA2_Channel10_IRQHandler
        B DMA2_Channel10_IRQHandler

        PUBWEAK DMA2_Channel11_IRQHandler
        SECTION .text:CODE:REORDER:NOROOT(1)
DMA2_Channel11_IRQHandler
        B DMA2_Channel11_IRQHandler
